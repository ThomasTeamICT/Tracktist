...
export const config = {
  ...
  // 0 is valid: it pauses syncing while keeping notification/digest runs.
  syncLimit: num(process.env.SYNC_LIMIT, 25, 0),
  staleHours: num(process.env.SYNC_STALE_HOURS, 24, 0),
